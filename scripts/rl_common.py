...
def reward(s, s2):
    ...
    r += 0.003 * (num(s2, "coal") - num(s, "coal"))
    r += 0.003 * (num(s2, "sand") - num(s, "sand"))
    r += 0.02 * (num(s2, "graphite") - num(s, "graphite"))
    r += 0.025 * (num(s2, "silicon") - num(s, "silicon"))
    r += 0.02 * (num(s2, "titanium") - num(s, "titanium"))
    r += 0.035 * (num(s2, "plastanium") - num(s, "plastanium"))
